      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <?php
          ...
          if($account)
          {
              ...
              echo"<h2><font color=red><center> No account is existed ! </center></font></h2>";
              ...
              <div class="col-12 col-lg-6 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form class="" action="{{ URL::to('user/forget-password/confirm') }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="form-group">
                                  <label for="exampleInputEmail1">Email</label>
                                  <input type="text" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="email"> 
                              </div>
