              ...
              <div class="col-12 col-lg-6 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form class="" action="{{ URL::to('user/confirm/email/'.$id) }}" method="post" enctype="multipart/form-data">
                          @csrf
                        
                              
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Email Verification Code</label>
                                  <input type="text" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter verification code" name="code"> 
                              </div>
