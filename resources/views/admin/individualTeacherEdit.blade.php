...
@php 
    ...
    $status = Session::get('teacher_update_status');
    ...
    if($message)
    {
        ...
        Session::put('teacher_status',null);
...
@if(Session::has('teacher_update_status'))
      ...
      @php
      Session::put('teacher_update_status',null);
      @endphp
              ...
              <div class="col-12 col-lg-6 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form class="" action="{{ Url('admin/teacher/update/'.$row->id) }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter contact no" name="contact" value ="{{ $row->contact }}">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="date" class="form-control p-input" id="exampleInputPassword1" placeholder="Enter birthdate" name="birth_date" value ="{{ $row->date_of_birth }}">
                              </div>
